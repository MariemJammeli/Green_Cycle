...
$search_query = isset($_POST['querry']) ? mysqli_real_escape_string($conn, $_POST['querry']) : '';

// Check if the search query is not empty 
if (!empty($search_query)) {
    // Query to search for products 
    $query_products = "SELECT * FROM `bike` WHERE `product_name` LIKE '%$search_query%' OR `product_category` LIKE '%$search_query%'";
...
<body>
    <nav>
        <div class="nav-bar">
            ...
            <span class="logo navLogo"><img src="logo (2).png" alt="Green Cycle" class="logo1"></span>
            <div class="menu">
    ...
    <div class="main-products">
        ...
        <div class="filters">
            ...
            <button><a href="mountainbikes.php" class="categoriess">Mountain Bikes</a></button>
        ...
        <div class="containerrr">
            <?php 
            if (!empty($search_query) && mysqli_num_rows($result_products) > 0) {
    ...
    body.addEventListener("click" , e =>{
        ...
        if(!clickedElm.classList.contains("sidebarOpen") && !clickedElm.classList.contains("siderbarClose") && !clickedElm.classList.contains("menu") && !clickedElm.classList.contains("nav-bar")){
